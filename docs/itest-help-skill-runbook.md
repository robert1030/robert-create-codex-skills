...
目的：列出所有第一層 `.htm/.html`，抽出檔名、title、H1、doc_set、可能分類。
...
- inventory 筆數等於新版本第一層 `.htm/.html` 數量。
- 空白 title 最好是 `0`。
...
若有殘留，將 `source_path` 改成邏輯來源：

```text
source_ref: topics/<file_name>
```
