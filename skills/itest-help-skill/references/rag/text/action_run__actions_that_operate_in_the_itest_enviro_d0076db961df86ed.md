---
{
  "chunk_id": "action_run__actions_that_operate_in_the_itest_enviro_d0076db961df86ed",
  ...
  "related_links": [],
  "images": [],
  "content_hash": "d0076db961df86ed",
  "level": 3
}
---

# The ‘eval’ action: Evaluate an iTest interpreter command > The ‘eval’ action: Evaluate an iTest interpreter command > About the iTest interpreter and the Python interpreters > Actions that operate in the iTest environment: eval
