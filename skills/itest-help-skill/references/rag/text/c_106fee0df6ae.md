# Command Prompt sessions > Session profile property settings for Command Prompt sessions (Microsoft Windows command line) > Note for Linux and Unix users: > Note This property setting has no effect for Command Prompt sessions. Terminal > Replay > Step Defaults > Terminator > 第3段
