# Bash sessions > Session profile property settings for Bash sessions (Ubuntu and RHEL) > For the Alt key, iTest captures only the last key pressed. For example, Alt+q is recorded as “q”. Function keys are not recorded. Terminal > Font
