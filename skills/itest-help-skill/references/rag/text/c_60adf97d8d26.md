# Parameters > Merging parameter definitions from multiple sources > How parameter definitions from multiple sources are merged at run time > Overview
...
1. 1 If you specified a value for param1 in the test case, iTest uses the value from the test case, and then:

1. 2 Finally, if you specified a value for param1 in the Global parameter file, iTest uses the value from the Global parameter file
