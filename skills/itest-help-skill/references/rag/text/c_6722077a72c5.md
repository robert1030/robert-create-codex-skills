# Spirent TestCenter sessions > Spirent TestCenter session profiles > Session profile property settings for Spirent TestCenter sessions
...
![](images/spirent_testcenter_gui_15.1.jpg) <!-- image_ref -->
