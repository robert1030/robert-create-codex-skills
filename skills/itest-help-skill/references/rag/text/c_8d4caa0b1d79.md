# QuickCalls: Defining and using a library of custom actions > Overview: QuickCalls > Overview: QuickCalls > Defining QuickCalls
...
1. 2 Copy Test Case steps (not a QuickCall) and paste them into a QuickCall test case.

1. 3 Set the procedure as “public” (that is, include the QuickCall name whenever a user asks to see a list of available QuickCalls).

1. 4 Repeat for as many QuickCalls as needed.
...
![](images/quickcalls.4.jpg) <!-- image_ref -->
...
> **Important：** Limitation Global variables defined in one QuickCall in the library cannot be accessed by other QuickCalls in the library.
