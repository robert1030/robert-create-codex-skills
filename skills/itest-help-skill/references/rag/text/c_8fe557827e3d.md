# Export a QuickCall to Robot Library > Execute exported Robot library from an external environment
...
![](images/robot_ride.png) <!-- image_ref -->
...
1. 2 Open Robot Framework IDE.

1. 3 Import the exported Robot library and the support file

Example: library_CMD_quickcall_library.py and iTestCommon.py

1. 4 Create a Robot test case with default value:
...
1. 5 Save and Run the Robot test case in Robot Framework IDE.
...
![](images/robot_framework.2.jpg) <!-- image_ref -->
