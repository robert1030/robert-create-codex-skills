# Telnet Sessions > Session profile property settings for Telnet sessions > For the Alt key, iTest captures only the last key pressed. For example, Alt+q is recorded as “q”. Function keys are not recorded. Terminal > Font
