# Popups（來源文件無 TOC 對應，依資料夾結構歸類） > popups/arules/AppendToProcedureResponse.html > AppendToProcedureResponse action

Writes the specified text to a procedures return buffer.
