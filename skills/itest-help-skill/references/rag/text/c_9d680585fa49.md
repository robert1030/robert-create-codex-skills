# Spirent TestCenter REST sessions > Spirent TestCenter REST session profiles > Session profile property settings for Spirent TestCenter REST sessions
...
![](images/spirent_testcenter_rest_3.1.jpg) <!-- image_ref -->
