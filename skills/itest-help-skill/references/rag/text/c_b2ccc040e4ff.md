# iTest Views > Activity View > Developing a test case > To add steps by capturing (start sessions with devices and save the captured steps into a test case) > 第1段
