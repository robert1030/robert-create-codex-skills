# Response Maps: Returning Data from Responses > Why create a response map? > A response map returns data from a response for analysis or for other uses
...
![](images/response_view_blue_text.png) <!-- image_ref -->
