# iTest Topology Editor > Velocity command > Commands that return information from Velocity > velocity command syntax > findReservations subcommand > Arguments:
...
| status | The following lists the valid values (string, optional): |
