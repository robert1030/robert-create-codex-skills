# Bash sessions > Session profile property settings for Bash sessions (Ubuntu and RHEL) > Note This property setting has no effect for Bash sessions. Terminal > Replay > Step Defaults > Terminator > 第3段
