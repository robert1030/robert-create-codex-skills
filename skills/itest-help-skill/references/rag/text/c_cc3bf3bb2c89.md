# Popups（來源文件無 TOC 對應，依資料夾結構歸類） > popups/arules/AbortExecution.html > AbortExecution action

Stops execution.

Note: Because this action alters the flow of execution, it is deferred (not executed) until all other actions for the step are executed. See About deferred actions.
