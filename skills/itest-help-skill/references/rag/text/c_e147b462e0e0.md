# iTest Commands > iTest interpreter commands > iTest interpreter and Python commands > About the iTest interpreter and the Python interpreters > Actions that operate in the iTest environment: eval
