# QuickCalls: Defining and using a library of custom actions > Library Template (QuickCalls) > Validation of QuickCalls against the associated template
...
![](images/qc_templ_changeProcName.png) <!-- image_ref -->
...
![](images/qc_templ_changeArgNameMandatorChkBox.png) <!-- image_ref -->
...
![](images/qc_templ_changeResponseBlockType.png) <!-- image_ref -->
