---
{
  "chunk_id": "executing_tests_preferences_execution__spirent_general_execution_49369ae7b76c58f5",
  "source_file": "topics/executing_tests_preferences_execution.htm",
  "source_original_path": "topics/executing_tests_preferences_execution.htm",
  "toc_path": [
    "iTest Online Help",
    "Executing Tests",
  ...
  "anchor": "1077420",
  "context_ids": [
    "executing_tests_preferences_execution"
  ],
  "index_keywords": [
    "execution",
    "preference settings"
  ...
  "index_keyword_paths": [
    "execution > preference settings",
    "preference settings > execution"
  ],
  "related_links": [
    "test_report_set_steps_that_appear_in_report.htm#1466765",
    "preferences.11.htm#1246560",
    "preferences.12.htm#1253533",
    "preferences_itest.htm#"
  ],
  "images": [],
  "content_hash": "49369ae7b76c58f5",
  "level": 2
}
---

# Setting preferences for execution > Setting preferences for execution > Spirent > General > Execution
...
| After execution, update “Estimated execution time” property in test case | The Estimated execution time property on the General page of the Test Case editor provides the best estimate of duration of execution for the test case. The value is used in two ways: On the Execution view during execution, to determine the progress on the Time remaining progress bar For use by test case scheduling applications Check the box to cause iTest to update the estimate when execution ends. The algorithm is (0.7*<current value>) + (0.3*<duration of latest execution>). The Estimated execution time value is not modified if: User cancels execution Test result is Failed or Abort Execution speed setting is not “fastest possible” Default: checked |
...
|  | Test result is Failed or Abort |
