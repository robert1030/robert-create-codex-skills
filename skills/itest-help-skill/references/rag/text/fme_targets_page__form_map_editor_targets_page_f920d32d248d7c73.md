---
{
  "chunk_id": "fme_targets_page__form_map_editor_targets_page_f920d32d248d7c73",
  ...
  "content_hash": "f920d32d248d7c73",
  "level": 1
}
---

# Form Map editor: Targets page > Form Map editor: Targets page
...
1. To improve on the suggested target names, select the target in the list and then edit the name as needed.
...
1. Use this section to define arguments for targets that take arguments.
