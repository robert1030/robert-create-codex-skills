---
{
  "chunk_id": "session_profile_properties_bash__terminal_replay_step_defaults_terminator_9455ee8c91cc762b",
  ...
  "images": [],
  "content_hash": "9455ee8c91cc762b",
  "level": 3
}
---

# Session profile property settings for Bash sessions (Ubuntu and RHEL) > Session profile property settings for Bash sessions (Ubuntu and RHEL) > Terminal > Replay > Step Defaults > Terminator

| Line terminator | Note This property setting has no effect for Bash sessions. | Note | This property setting has no effect for Bash sessions. |
| --- | --- | --- | --- |
| Note | This property setting has no effect for Bash sessions. |  |  |

Terminal > Replay > Step Defaults > Response

| Treat LF as CRLF | Note This property setting has no effect for Bash sessions. Default: Checked | Note | This property setting has no effect for Bash sessions. |
| --- | --- | --- | --- |
| Note | This property setting has no effect for Bash sessions. |  |  |
