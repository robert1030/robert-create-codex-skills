---
{
  "chunk_id": "session_profile_properties_cmd__terminal_c1872bf853132504",
  ...
  "related_links": [],
  "images": [],
  "content_hash": "c1872bf853132504",
  "level": 3
}
---

# Session profile property settings for Command Prompt sessions (Microsoft Windows command line) > Session profile property settings for Command Prompt sessions (Microsoft Windows command line) > Note for Linux and Unix users: > Terminal
