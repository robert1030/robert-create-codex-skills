---
{
  "chunk_id": "session_profile_properties_cmd__terminal_prompts_a33837df964b83d7",
  ...
  "images": [],
  "content_hash": "a33837df964b83d7",
  "level": 3
}
---

# Session profile property settings for Command Prompt sessions (Microsoft Windows command line) > Session profile property settings for Command Prompt sessions (Microsoft Windows command line) > Note for Linux and Unix users: > Terminal > Prompts
...
| Name | Note This property setting has no effect for Command Prompt sessions. | Note | This property setting has no effect for Command Prompt sessions. |
| --- | --- | --- | --- |
