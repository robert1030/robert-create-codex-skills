---
{
  "chunk_id": "ui_perspective_overview_2__itest_expert_perspective_d4d101e722146e9a",
  ...
  "related_links": [],
  "images": [],
  "content_hash": "d4d101e722146e9a",
  "level": 2
}
---

# Overviews of the default iTest perspectives > Overviews of the default iTest perspectives > iTest Expert Perspective
...
Use the iTest Expert perspective while you develop tests cases to share with other users via Git repository. You add captured items to a new or existing test case, edit response maps, view validation of your changes, etc.

The views, editors, and tool bars that appear in the iTest Expert perspective are optimized to support the tasks that you, an iTest expert user, perform.
...
The Properties view displays information depending on your selection, that is, whether you have selected a test case step or an item in the Project Explorer (alphabetically). You may edit step properties using either the Step Properties section (within the Test Case Editor) or via the Properties View window.
